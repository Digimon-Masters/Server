...
{
    /// <inheritdoc />
    public partial class NpcPortalImp : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NpcPortal", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NpcPortal_Npc_NpcAssetId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NpcPortals", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTime(2024, 1, 4, 21, 21, 31, 501, DateTimeKind.Local).AddTicks(3847), new DateTime(2024, 1, 5, 0, 0, 0, 0, DateTimeKind.Local) });

            migrationBuilder.CreateIndex(
                name: "IX_NpcPortal_NpcAssetId",
                schema: "Asset",
                table: "NpcPortal",
                column: "NpcAssetId");

            migrationBuilder.CreateIndex(
                name: "IX_NpcPortals_NpcAssetId",
                schema: "Asset",
                table: "NpcPortals",
                column: "NpcAssetId");
        }
