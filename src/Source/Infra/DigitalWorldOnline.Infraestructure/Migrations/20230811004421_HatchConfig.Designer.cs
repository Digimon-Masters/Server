...
namespace DigitalWorldOnline.Infraestructure.Migrations
{
    ...
    [Migration("20230811004421_HatchConfig")]
    partial class HatchConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Config.HashDTO", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 8, 10, 21, 44, 20, 391, DateTimeKind.Local).AddTicks(1856),
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Routine.RoutineDTO", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Active = true,
                            CreatedAt = new DateTime(2023, 8, 10, 21, 44, 20, 399, DateTimeKind.Local).AddTicks(3439),
                            Interval = 1,
                            Name = "Daily Quests",
                            NextRunTime = new DateTime(2023, 8, 11, 0, 0, 0, 0, DateTimeKind.Local),
                            Type = 1
                        });
                });
