...
namespace DigitalWorldOnline.Infraestructure.Migrations
{
    ...
    [Migration("20231223135840_AchievementImp")]
    partial class AchievementImp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Config.HashDTO", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 12, 23, 10, 58, 39, 417, DateTimeKind.Local).AddTicks(1916),
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Routine.RoutineDTO", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Active = true,
                            CreatedAt = new DateTime(2023, 12, 23, 10, 58, 39, 428, DateTimeKind.Local).AddTicks(567),
                            Interval = 1,
                            Name = "Daily Quests",
                            NextRunTime = new DateTime(2023, 12, 24, 0, 0, 0, 0, DateTimeKind.Local),
                            Type = 1
                        });
                });
