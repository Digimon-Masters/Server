...
{
    /// <inheritdoc />
    public partial class ScanDetailAsset : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScanDetail", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ScanRewardDetail",
                schema: "Asset",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScanRewardDetail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScanRewardDetail_ScanDetail_ScanDetailAssetId",
                        column: x => x.ScanDetailAssetId,
                        principalSchema: "Asset",
                        principalTable: "ScanDetail",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ScanRewardDetail_ScanDetailAssetId",
                schema: "Asset",
