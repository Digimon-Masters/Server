...
{
    /// <inheritdoc />
    public partial class ColiseumSystemImp : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArenaPoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArenaPoints_Tamer_CharacterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NpcColiseum", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NpcMobInfo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NpcMobInfo_NpcColiseum_NpcAssetId",
                        column: x => x.NpcAssetId,
                        principalSchema: "Asset",
                        principalTable: "NpcColiseum",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTime(2024, 1, 7, 0, 31, 6, 39, DateTimeKind.Local).AddTicks(8956), new DateTime(2024, 1, 8, 0, 0, 0, 0, DateTimeKind.Local) });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1L,
                column: "CreatedAt",
                value: new DateTime(2024, 1, 6, 21, 28, 52, 902, DateTimeKind.Local).AddTicks(3976));
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1L,
                columns: new[] { "CreatedAt", "NextRunTime" },
                values: new object[] { new DateTime(2024, 1, 6, 21, 28, 52, 912, DateTimeKind.Local).AddTicks(3599), new DateTime(2024, 1, 7, 0, 0, 0, 0, DateTimeKind.Local) });
        }
    }
}
