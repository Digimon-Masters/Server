...
namespace DigitalWorldOnline.Infraestructure.Migrations
{
    ...
    [Migration("20230524205557_ItemStatusRef")]
    partial class ItemStatusRef
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Base.ItemAccessoryStatusDTO", b =>
                {
                    ...
                    b.ToTable("ItemAccessoryStatus", "Config");
                });
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Base.ItemAccessoryStatusDTO", b =>
                {
                    b.HasOne("DigitalWorldOnline.Commons.DTOs.Account.AccountItemDTO", null)
                        .WithMany("AccessoryStatus")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DigitalWorldOnline.Commons.DTOs.Character.CharacterItemDTO", null)
                        .WithMany("AccessoryStatus")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_ItemAccessoryStatus_Item_ItemId1");
                });
