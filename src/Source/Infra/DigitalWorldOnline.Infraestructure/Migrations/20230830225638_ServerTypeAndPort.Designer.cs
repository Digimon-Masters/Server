...
namespace DigitalWorldOnline.Infraestructure.Migrations
{
    ...
    [Migration("20230830225638_ServerTypeAndPort")]
    partial class ServerTypeAndPort
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Config.HashDTO", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 8, 30, 19, 56, 37, 282, DateTimeKind.Local).AddTicks(9816),
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Routine.RoutineDTO", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Active = true,
                            CreatedAt = new DateTime(2023, 8, 30, 19, 56, 37, 290, DateTimeKind.Local).AddTicks(7231),
                            Interval = 1,
                            Name = "Daily Quests",
                            NextRunTime = new DateTime(2023, 8, 31, 0, 0, 0, 0, DateTimeKind.Local),
                            Type = 1
                        });
                });
