...
namespace DigitalWorldOnline.Infraestructure.Migrations
{
    ...
    [Migration("20240626202347_CreateCashShopDatabase")]
    partial class CreateCashShopDatabase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Config.HashDTO", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 6, 26, 21, 23, 45, 786, DateTimeKind.Local).AddTicks(2469),
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Routine.RoutineDTO", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Active = true,
                            CreatedAt = new DateTime(2024, 6, 26, 21, 23, 45, 793, DateTimeKind.Local).AddTicks(1930),
                            Interval = 1,
                            Name = "Daily Quests",
                            NextRunTime = new DateTime(2024, 6, 27, 0, 0, 0, 0, DateTimeKind.Local),
                            Type = 1
                        });
                });
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Shop.CashShopDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("PurchaseCashType")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CashShop", "Shop");
                });

            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Shop.CashShopItemsDTO", b =>
                {
                    b.Property<int>("UniqueId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("UniqueId", "ItemId");

                    b.HasIndex("ItemId");

                    b.ToTable("CashShopItems", "Shop");
                });
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Shop.CashShopItemsDTO", b =>
                {
                    b.HasOne("DigitalWorldOnline.Commons.DTOs.Assets.ItemAssetDTO", "ItemAssetNavigation")
                        .WithMany("CashShopItemsNavigation")
                        .HasForeignKey("ItemId")
                        .HasPrincipalKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DigitalWorldOnline.Commons.DTOs.Shop.CashShopDTO", "CashShopNavigation")
                        .WithMany("CashShopItemsNavigation")
                    ...
                    b.Navigation("CashShopNavigation");

                    b.Navigation("ItemAssetNavigation");
                });
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Assets.ItemAssetDTO", b =>
                {
                    b.Navigation("CashShopItemsNavigation");
                });
