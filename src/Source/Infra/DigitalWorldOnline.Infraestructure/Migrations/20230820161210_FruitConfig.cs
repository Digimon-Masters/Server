...
{
    /// <inheritdoc />
    public partial class FruitConfig : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Size = table.Column<decimal>(type: "numeric(38,17)", nullable: false),
                    Chance = table.Column<decimal>(type: "numeric(38,17)", nullable: false),
                    FruitConfigId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FruitSize", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FruitSize_Fruit_FruitConfigId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FruitSize_FruitConfigId",
                schema: "Config",
                table: "FruitSize",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1L,
                column: "CreatedAt",
                value: new DateTime(2023, 8, 19, 4, 38, 52, 918, DateTimeKind.Local).AddTicks(1386));
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1L,
                columns: new[] { "CreatedAt", "NextRunTime" },
                values: new object[] { new DateTime(2023, 8, 19, 4, 38, 52, 923, DateTimeKind.Local).AddTicks(5932), new DateTime(2023, 8, 20, 0, 0, 0, 0, DateTimeKind.Local) });
        }
    }
}
