...
namespace DigitalWorldOnline.Infraestructure.Migrations
{
    ...
    [Migration("20230611202702_ResourcesHashTable")]
    partial class ResourcesHashTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Config.HashDTO", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 6, 11, 17, 27, 1, 744, DateTimeKind.Local).AddTicks(6907),
