...
{
    /// <inheritdoc />
    public partial class HatchAsset : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Hatch", x => x.Id);
                });
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTime(2023, 7, 30, 15, 29, 44, 805, DateTimeKind.Local).AddTicks(6597), new DateTime(2023, 7, 31, 0, 0, 0, 0, DateTimeKind.Local) });

            migrationBuilder.Sql("UPDATE Character.Incubator SET EggId = 0, HatchLevel = 0, BackupDiskId = 0;");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1L,
                column: "CreatedAt",
                value: new DateTime(2023, 7, 23, 17, 40, 55, 46, DateTimeKind.Local).AddTicks(2383));
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1L,
                columns: new[] { "CreatedAt", "NextRunTime" },
                values: new object[] { new DateTime(2023, 7, 23, 17, 40, 55, 51, DateTimeKind.Local).AddTicks(3196), new DateTime(2023, 7, 24, 0, 0, 0, 0, DateTimeKind.Local) });
        }
    }
}
