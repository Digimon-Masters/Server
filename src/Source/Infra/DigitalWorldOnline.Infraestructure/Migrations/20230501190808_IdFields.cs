    ...
    public partial class IdFields : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ALTER TABLE Character.Seal
                DROP CONSTRAINT PK_Seal;");
            ...
            migrationBuilder.Sql(@"
                EXEC sp_rename 
                    'Character.Seal.Id_new', 
                    'Id', 
                    'COLUMN';");

            migrationBuilder.Sql(@"
                ALTER TABLE Character.Seal
                ADD CONSTRAINT PK_Seal PRIMARY KEY (Id);");
            ...
            migrationBuilder.Sql(@"
                ALTER TABLE Digimon.Buff
                DROP CONSTRAINT PK_Buff;");
