...
{
    /// <inheritdoc />
    public partial class AccessoryStatusList : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessoryRoll", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AccessoryRollStatus",
                schema: "Asset",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessoryRollStatus", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccessoryRollStatus_AccessoryRoll_AccessoryRollAssetId",
                        column: x => x.AccessoryRollAssetId,
                        principalSchema: "Asset",
                        principalTable: "AccessoryRoll",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AccessoryRollStatus_AccessoryRollAssetId",
                schema: "Asset",
                table: "AccessoryRollStatus",
