...
namespace DigitalWorldOnline.Infraestructure.Migrations
{
    ...
    [Migration("20240208172308_KillSpawnRefactor")]
    partial class KillSpawnRefactor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Config.HashDTO", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 2, 8, 14, 23, 6, 842, DateTimeKind.Local).AddTicks(2802),
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Routine.RoutineDTO", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Active = true,
                            CreatedAt = new DateTime(2024, 2, 8, 14, 23, 6, 854, DateTimeKind.Local).AddTicks(4617),
                            Interval = 1,
                            Name = "Daily Quests",
                            NextRunTime = new DateTime(2024, 2, 9, 0, 0, 0, 0, DateTimeKind.Local),
                            Type = 1
                        });
                });
