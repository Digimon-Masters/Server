...
{
    /// <inheritdoc />
    public partial class ContainerTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rare = table.Column<bool>(type: "bit", nullable: false),
                    ContainerAssetId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContainerReward", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContainerReward_Container_ContainerAssetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContainerReward_ContainerAssetId",
                schema: "Asset",
