...
namespace DigitalWorldOnline.Infraestructure.Migrations
{
    ...
    [Migration("20231020185606_TamerSkillCooltime")]
    partial class TamerSkillCooltime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Config.HashDTO", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 10, 20, 15, 56, 3, 818, DateTimeKind.Local).AddTicks(7765),
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Routine.RoutineDTO", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Active = true,
                            CreatedAt = new DateTime(2023, 10, 20, 15, 56, 3, 838, DateTimeKind.Local).AddTicks(7538),
                            Interval = 1,
                            Name = "Daily Quests",
                            NextRunTime = new DateTime(2023, 10, 21, 0, 0, 0, 0, DateTimeKind.Local),
                            Type = 1
                        });
                });
