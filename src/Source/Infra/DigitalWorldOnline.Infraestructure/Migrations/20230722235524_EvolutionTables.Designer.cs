...
namespace DigitalWorldOnline.Infraestructure.Migrations
{
    ...
    [Migration("20230722235524_EvolutionTables")]
    partial class EvolutionTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Config.HashDTO", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 7, 22, 20, 55, 23, 412, DateTimeKind.Local).AddTicks(2340),
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Routine.RoutineDTO", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Active = true,
                            CreatedAt = new DateTime(2023, 7, 22, 20, 55, 23, 417, DateTimeKind.Local).AddTicks(616),
                            Interval = 1,
                            Name = "Daily Quests",
                            NextRunTime = new DateTime(2023, 7, 23, 0, 0, 0, 0, DateTimeKind.Local),
                            Type = 1
                        });
                });
