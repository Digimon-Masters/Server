...
namespace DigitalWorldOnline.Infraestructure.Migrations
{
    ...
    [Migration("20230723204056_ItemAssetFix")]
    partial class ItemAssetFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Config.HashDTO", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 7, 23, 17, 40, 55, 46, DateTimeKind.Local).AddTicks(2383),
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Routine.RoutineDTO", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Active = true,
                            CreatedAt = new DateTime(2023, 7, 23, 17, 40, 55, 51, DateTimeKind.Local).AddTicks(3196),
                            Interval = 1,
                            Name = "Daily Quests",
                            NextRunTime = new DateTime(2023, 7, 24, 0, 0, 0, 0, DateTimeKind.Local),
                            Type = 1
                        });
                });
