            ...
            using (var conn = new SqlConnection(cs))
            {
                ...
                foreach (var target in newDataList.DigimonBaseList)
                {
                    ...
                    for (int i = 1; i <= 4; i++) // Loop para as quatro habilidades
                    {
                        ...
                        int skillId = 0; // Vari�vel para armazenar o SkillId atual
                        switch (i)
                        {
                            case 1:
                    ...
                    conn.Close(); // Lembre-se de fechar a conex�o fora do loop
                }
            }
        }
        ...
        private static void SummonImport(string cs, string[] files)
        {
            ...
            using (SqlConnection connection = new SqlConnection(cs))
            {
                foreach (var summond in maindata.SummonDTOs)
                {
                    ...
                    // Supondo que summon.ItemId � do tipo int
                    ...
                    // Adicionando o par�metro @Maps como NVARCHAR
                    ...
                    // Verifique se a consulta retornou um valor antes de tentar convert�-lo para long
                    if (result != null && result != DBNull.Value)
                    {
                        summonId = Convert.ToInt64(result);
                        // Fa�a o que precisa ser feito com o summonId aqui
                    }
                    else
                    {
                        // Lidar com um cen�rio onde n�o foi poss�vel obter o ID inserido
                    }
                ...
                // Opera��es de inser��o conclu�das, pode fazer commit da transa��o se necess�rio
            }
        }
